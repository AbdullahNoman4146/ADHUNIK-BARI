...
namespace ADHUNIK_BARI.Migrations
{
    ...
    [Migration("20260926005500_AddGymMembershipCardAndFeePaid")]
    partial class AddGymMembershipCardAndFeePaid
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ADHUNIK_BARI.Models.CctvCameraFlatAccess", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CameraId", "FlatId")
                        .IsUnique();

                    b.ToTable("CctvCameraFlatAccesses", (string)null);
                });
            ...
            modelBuilder.Entity("ADHUNIK_BARI.Models.GymMembership", b =>
                {
                    b.Property<int>("GymMembershipId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("GymMembershipId"));
            ...
            modelBuilder.Entity("ADHUNIK_BARI.Models.GymSetting", b =>
                {
                    b.Property<int>("GymSettingId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("GymSettingId"));
                    ...
                    b.Property<string>("RulesAndGuidelines")
                        .HasMaxLength(2000)
                        .HasColumnType("nvarchar(2000)");
            ...
            modelBuilder.Entity("ADHUNIK_BARI.Models.ParkingActivityLog", b =>
                {
            ...
            modelBuilder.Entity("ADHUNIK_BARI.Models.ParkingFloor", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ParkingFloorId"));
            ...
            modelBuilder.Entity("ADHUNIK_BARI.Models.ParkingSpot", b =>
                {
                    ...
                    b.Property<string>("ListingNotes")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
            ...
            modelBuilder.Entity("ADHUNIK_BARI.Models.PropertyApplication", b =>
                {
                    b.Property<int>("PropertyApplicationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("PropertyApplicationId"));
                    ...
                    b.Property<string>("CreatedResidentUserId")
                        .HasMaxLength(450)
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasKey("PropertyApplicationId");

                    b.HasIndex("CreatedResidentUserId");
            ...
            modelBuilder.Entity("ADHUNIK_BARI.Models.PropertyListing", b =>
                {
                    ...
                    b.Property<string>("RoomLayoutImagePath")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
            ...
            modelBuilder.Entity("ADHUNIK_BARI.Models.CctvCameraFlatAccess", b =>
                {
                    b.HasOne("ADHUNIK_BARI.Models.CctvCamera", "Camera")
                        .WithMany("FlatAccesses")
            ...
            modelBuilder.Entity("ADHUNIK_BARI.Models.GymMembership", b =>
                {
                    b.HasOne("ADHUNIK_BARI.Models.ApplicationUser", "ApprovedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("ADHUNIK_BARI.Models.GymSetting", b =>
                {
                    b.HasOne("ADHUNIK_BARI.Models.ApplicationUser", "UpdatedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("ADHUNIK_BARI.Models.ParkingSpot", b =>
                {
                    ...
                    b.HasOne("ADHUNIK_BARI.Models.ParkingFloor", "Floor")
            ...
            modelBuilder.Entity("ADHUNIK_BARI.Models.PropertyApplication", b =>
                {
                    b.HasOne("ADHUNIK_BARI.Models.ApplicationUser", "CreatedResidentUser")
                        .WithMany()
                        .HasForeignKey("CreatedResidentUserId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("ADHUNIK_BARI.Models.PropertyListing", "PropertyListing")
                        .WithMany("Applications")
                        .HasForeignKey("PropertyListingId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("CreatedResidentUser");
            ...
            modelBuilder.Entity("ADHUNIK_BARI.Models.PropertyListing", b =>
                {
                    b.HasOne("ADHUNIK_BARI.Models.ApplicationUser", "CreatedByUser")
                        .WithMany()
                        .HasForeignKey("CreatedByUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
